...
<%
String adminCheckmess="";
adminCheckmess=(String)request.getAttribute("adminCheckmess");
if(adminCheckmess==null){
	adminCheckmess="管理员登录";
}
%>
<body>  
	<div style="background: cyan;height: 1000px">
        ...
        <h1><%=adminCheckmess %></h1>  
        <form  action="hdadmin" method="post">  

            <input type="text"  placeholder="用户名" name="aname"></input>  
            <br>
            <input type="password"  placeholder="密码" name="apassword"></input>  
